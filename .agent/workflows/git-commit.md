...
put fix,feature,impromevement,config to begişinning of the commit message based on the context 
run git push

!! do not ask permission to run the commands for git status, add commit and push !! 