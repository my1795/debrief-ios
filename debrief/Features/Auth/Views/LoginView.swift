        ...
        ZStack {
            ...
            VStack(spacing: 0) {
                ...
                VStack(spacing: 24) {
                    ...
                    .padding(16)
                    .background(Color(hex: "2DD4BF").opacity(0.1)) // teal-400 equivalent
                    .overlay(
                        RoundedRectangle(cornerRadius: 8)
                            .stroke(Color(hex: "5EEAD4").opacity(0.2), lineWidth: 1) // teal-300
                    )
                    .foregroundStyle(Color(hex: "99F6E4")) // teal-200
                }
                .padding(32)
